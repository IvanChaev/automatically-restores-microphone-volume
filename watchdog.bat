...
set "RAISEDFILE=%~dp0logs\raised.flag"
set "STARTBAT=%~dp0mic_100.bat"
...
:check_raised_flag
set "RAISED="
if not exist "!RAISEDFILE!" exit /b 0
for /f "usebackq delims=" %%i in ("!RAISEDFILE!") do set "RAISED=%%i"
if exist "!RAISEDFILE!" del "!RAISEDFILE!" 2>nul
if not defined RAISED set "RAISED=до 100%"
call :log "ИНФО: программа повысила громкость микрофона: !RAISED!"
exit /b 0
